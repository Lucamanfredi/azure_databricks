...
# MAGIC To expand on the analysis, attach this notebook to the **job-161869107836550-run-142-Shared_job_cluster** cluster,
...
# MAGIC - Explore completed trials in the [MLflow experiment](#mlflow/experiments/1005448801905243)
...
client = MlflowClient()
training_data_path = client.download_artifacts("19b8d6bf45b0453f8573db66c57a14b8", "data", temp_dir)
...
df = df.drop(['_automl_split_col_97b2'], axis=1)
