...
# MAGIC This is an auto-generated notebook. To reproduce these results, attach this notebook to the **job-161869107836550-run-5403-Shared_job_cluster** cluster and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/1005448801907223)
...
input_data_path = input_client.download_artifacts("6c501e0e663141f9bdb4054443821427", "data", input_temp_dir)
...
# MAGIC 
# MAGIC `_automl_split_col_5380` contains the information of which set a given row belongs to.
...
# AutoML completed train - validation - test split internally and used _automl_split_col_5380 to specify the set
split_train_df = df_loaded.loc[df_loaded._automl_split_col_5380 == "train"]
split_val_df = df_loaded.loc[df_loaded._automl_split_col_5380 == "val"]
split_test_df = df_loaded.loc[df_loaded._automl_split_col_5380 == "test"]

# Separate target column from features and drop _automl_split_col_5380
X_train = split_train_df.drop([target_col, "_automl_split_col_5380"], axis=1)
y_train = split_train_df[target_col]

X_val = split_val_df.drop([target_col, "_automl_split_col_5380"], axis=1)
y_val = split_val_df[target_col]

X_test = split_test_df.drop([target_col, "_automl_split_col_5380"], axis=1)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/1005448801907223)
...
def objective(params):
  with mlflow.start_run(experiment_id="1005448801907223", run_name="lightgbm") as mlflow_run:
...
space = {
  "colsample_bytree": 0.40475558927704147,
  "lambda_l1": 0.10250394000611306,
  "lambda_l2": 0.13498504247110948,
  "learning_rate": 0.430814970429435,
  "max_bin": 297,
  "max_depth": 3,
  "min_child_samples": 46,
  "n_estimators": 6,
  "num_leaves": 499,
  "path_smooth": 0.5002190382099982,
  "subsample": 0.7032572861301506,
  "random_state": 756687056,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=756687056)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=756687056)
...
print(f"%md [Link to model run page](#mlflow/experiments/1005448801907223/runs/{ mlflow_run.info.run_id }/artifactPath/model)")
